...
describe( 'Basic rendering', () => {
	it( 'should render with required props', () => {
		...
		const activeViewportLabel = Array.from( container.querySelectorAll( 'label' ) ).find(
			( label ) => label.innerHTML.includes( 'All' )
		);
	...
	it( 'should pass custom label for default control group to the renderDefaultControl function when provided', () => {
		...
		const defaultControlLabel = Array.from( container.querySelectorAll( 'label' ) ).find(
			( label ) => label.innerHTML.includes( 'Everything' )
		);
