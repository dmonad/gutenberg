	...
	return (
		<Fill>
			{ ( { innerFloatingToolbar } ) => {
				const fillStyle = getStylesFromColorScheme(
					styles.floatingToolbarFillColor,
					styles.floatingToolbarFillColorDark
				);
				return (
					<TouchableWithoutFeedback>
						<View
							...
							style={ [
								fillStyle,
								styles.floatingToolbarFill,
								{ top: innerFloatingToolbar ? 0 : -44 },
							] }
						>
							{ children }
						</View>
